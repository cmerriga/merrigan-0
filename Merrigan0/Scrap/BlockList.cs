...
//        private List<IList<T>> blocks = new List<IList<T>>();
...
//        /// </remarks>
//        public override T this[int index] { get { return blocks[index / BlockSize][index % BlockSize]; } }
...
//        public FixedSizeBlockList(IList<T> loadedItems) { this.loadedItems = loadedItems; }
