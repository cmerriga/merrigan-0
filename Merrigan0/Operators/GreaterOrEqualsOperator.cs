...
namespace Merrigan0 {
    [Untested]
    public class GreaterOrEqualsOperator : ComparisonOperator {
        public static GreaterOrEqualsOperator Only = new GreaterOrEqualsOperator();

        protected GreaterOrEqualsOperator()
            : base(">=") {
