...
namespace Merrigan0.Internal.CodeTemplates.Collections.Generic {
    // https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.icollection-1?view=netframework-2.0
    // Last updated 8/26/24.
    //// This file updated only. Others must comply
    internal interface ICollection<T> : System.Collections.Generic.IEnumerable<T> {
        /// <summary>
    ...
    internal class ExampleCollection<T> : ICollection<T> {
        /// <summary>
        /// Gets the number of elements contained in the <see cref="ICollection{T}"/>.
        /// </summary>
        /// <value>The number of elements contained in the <see cref="ICollection{T}"/>.</value>
