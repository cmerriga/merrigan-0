...
//using Merrigan0.Internal.Matrixes;
//using Merrigan0.SetsInternal;

//namespace Merrigan0 {
//    // A 2-D array of numeric types.
//    [Untested]
//    public abstract class Matrix<T> : Array<Array<T>> {
//    public static readonly Matrix<T> Empty = new EmptyMatrix<T>();
...
//        //    T[,] block = new T[h, w];
//        //    for (long r = 0L; r < h; ++r) {
//        //        Array<T> row = m1.Row(r);
//        //        for (long c = 0L; c < w; ++c) {
//        //            block[r, c] = row.Dot(m2.Column(c), (t1, t2) => NumericOperators<T>t1 * t2);
//        //        }
//        //    }
...
//        static Matrix() {
//            if (!Reflection.Numeric(typeof(T))) {
