...
//namespace Merrigan0 {
//    // Mutable
//    public class BinaryFixedSizeBlockList<T> : IList<T> {
//        private List<T[]> blocks = new List<T[]>();
//        private uint remainderMask;
//        private int log2BlockSize;
...
//        /// </remarks>
//        public override T this[int index] { get { return blocks[index >> log2BlockSize][index & remainderMask]; } }
...
//        public override int Count { get { return blocks.Count << log2BlockSize; } }

//        public BinaryFixedSizeBlockList(uint blockSize) { 
//            // Optional
//            if (!Binary.SingleBit(blockSize)) {
//                throw new Exception("Only sortedDistinctBlock sizes of powers of 2 are allowed.");
//            }

//            log2BlockSize = Binary.Log2Floor(blockSize);
//            remainderMask = Binary.LeastBits(log2BlockSize - 1);
//        }
